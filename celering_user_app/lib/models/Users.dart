...
class Users extends Model {
  ...
  const Users._internal({required this.id, required email, password, createdAt, updatedAt}): _email = email, _password = password, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Users({String? id, required String email, String? password}) {
  ...
  Users copyWith({String? id, String? email, String? password}) {
    return Users._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'email': _email, 'password': _password, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
